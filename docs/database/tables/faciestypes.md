---
title: Faciestypes
description: Lookup table of Facies Types. Table is referenced by the AnalysisUnits table.
status: draft
...
[![Visual Schema](https://img.shields.io/badge/Visual_Schema-ndb%2efaciestypes-blue?style=flat-square)](https://open.neotomadb.org/dbschema/ndb/faciestypes.html)

{{ table_structure("faciestypes") }}

## Statistics

{{ table_stats("faciestypes") }}
